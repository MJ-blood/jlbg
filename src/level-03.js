...
export function createLevel(scene) {
  ...
  for (const x of [-0.23, 0.23]) box([0.04, 0.5, 0.04], [x, 0.87, 0], m.gold, ['lamp'], lamp);
  mesh(new THREE.ConeGeometry(0.34, 0.28, 4), m.gold, [0, 1.25, 0], ['lamp'], lamp).rotation.y = Math.PI / 4;
